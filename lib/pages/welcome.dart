                  ...
                  onChanged: (String value) {
                    debounce(() {
                      if (value.length == 9 ||
                        ...
                        service.postPointCardTrack(
                          ...
                          if (model.status == true  && idPass!.isNotEmpty) {
                            ...
                            service.postPointCardTrack(
                              ...
                              Navigator.of(context).push(MyRoute(page: HomePage(
                                    ...
                                    email: model.data.email,
                                    title: model.data.title,
                                    tiername: modelShort!.data.tierName ?? model.data.tiername,
                                    currentPoint: model.data.loyaltyPointsCurrent,
                                    dailyPoint: model.data.loyaltyPointsToday,
                                    dailyPointSlot:model.data.loyaltyPointTodayRLTB,
                                    dailyPointRLTB:model.data.loyaltyPointTodaySlot,
                                    totalPoint: model.data.loyaltyPoints,
                                    weeklyPoint: model.data.loyaltyPointsWeek,
                                    monthlyPoint:model.data.loyaltyPointsMonth)));
                            });
                            ...
                            showToastLong('CAN NOT FIND INFORMATION WITH THIS CARD');
                            turnOffProgressLoad();
                            controller.clear();
                        ...
                        turnOffProgressLoad();
                        showToastLong(
                            'CAN NOT FIND INFORMATION WITH THIS CARD');
                      }
                    });
                  },
