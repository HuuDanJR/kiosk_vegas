...
Widget part1(
  ...
  return Container(
    ...
    child: Row(
      children: [
        Container(
            margin: EdgeInsets.all(StringFactory.padding032),
            height: height,
            width: width * .3,
            decoration: BoxDecoration(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  rowWidget(
                    widget1: textCustom(
                        text: "CURRENT POINT", isBold: true, size: 29),
                  ...
                  rowWidget(
                    widget1: textCustom(text: "TIER FRAME", isBold: false, size: 18),
                    widget2: textCustomNormalColor(
                        text: "$tierFrame",
                        color: MyColor.pinkMain,
                        isBold: true,
                  ...
                  rowWidget(
                    widget1: textCustom(
                        text: "POINT FRAME", isBold: false, size: 18),
                    widget2: textCustomNormalColor(
                        text: "$pointFrame",
                        color: MyColor.pinkMain,
                        isBold: true,
                  ...
                  rowWidget(
                    widget1: textCustom(
                        text: "POINT TO NEXT LEVEL", isBold: false, size: 18),
                    widget2: textCustomNormalColor(
                        text: "$pointNextLevel",
                        color: MyColor.pinkMain,
                        isBold: true,
                  ...
                  rowWidget(
                    widget1: columnWidget(
                      widget1: textCustom(
                          text: "DAILY POINT", isBold: false, size: 22),
                      widget2: textCustomNormalColor(
                          text: "$dailyPoint",
                          color: MyColor.pinkMain,
                          isBold: true,
                    ...
                    widget2: Column(
                      ...
                      children: [
                        ...
                        rowWidget(
                          widget1: textCustom(
                              text: "DAILY RL-TB: ", isBold: false, size: 22),
                          widget2: textCustomNormalColor(
                              text: "$pointDailyRLTB",
                              color: MyColor.pinkMain,
                              isBold: true,
